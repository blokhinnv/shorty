...
func (m *MockStorage) GetURLByID(arg0 context.Context, arg1 string) (storage.Record, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) GetURLsByUser(arg0 context.Context, arg1 uint32) ([]storage.Record, error) {
	m.ctrl.T.Helper()
